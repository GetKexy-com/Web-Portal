  ...
  template: `
    <div class="toolbar-strip">
      <div class="toolbar-scroll">
        ...
        <!-- Source -->
        <button class="tool-btn" [class.active]="state.sourceMode()" title="Source code" (click)="canvas?.toggleSourceMode()">
        ...
        <!-- Lists -->
        <button class="tool-btn" title="Bullet list" (click)="canvas?.execCommand('insertUnorderedList')">
        ...
        <button class="tool-btn" title="Numbered list" (click)="canvas?.execCommand('insertOrderedList')">
        ...
        <button class="tool-btn" title="Checklist" (click)="canvas?.insertChecklist()">
        ...
        <!-- Undo / Redo -->
        <button class="tool-btn" title="Undo" (click)="canvas?.execCommand('undo')">
        ...
        <button class="tool-btn" title="Redo" (click)="canvas?.execCommand('redo')">
        ...
        <!-- Insert -->
        <button class="tool-btn" title="Insert image" (click)="imageFileInput.click()">
        ...
        <button class="tool-btn" title="Insert link" (click)="canvas?.insertLink()">
        ...
        <!-- Text format -->
        <button class="tool-btn fmt" title="Bold" (click)="canvas?.execCommand('bold')"><strong>B</strong></button>
        <button class="tool-btn fmt" title="Italic" (click)="canvas?.execCommand('italic')"><em>I</em></button>
        <button class="tool-btn fmt" title="Underline" (click)="canvas?.execCommand('underline')"><span class="u">U</span></button>
        <button class="tool-btn fmt" title="Strikethrough" (click)="canvas?.execCommand('strikeThrough')"><s>S</s></button>

        <span class="tool-divider"></span>

        <!-- Alignment dropdown -->
        <div class="align-tool">
          <button class="tool-btn with-caret" title="Text alignment" [class.active]="alignOpen()" (click)="toggleAlign()">
          ...
          @if (alignOpen()) {
            <div class="align-menu" role="menu">
              <button class="tool-btn" title="Align left" (click)="applyAlign('justifyLeft')">
                <svg class="tool-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="15" y2="12"/><line x1="3" y1="18" x2="18" y2="18"/></svg>
              </button>
              <button class="tool-btn" title="Align center" (click)="applyAlign('justifyCenter')">
              ...
              <button class="tool-btn" title="Align right" (click)="applyAlign('justifyRight')">
              ...
              <button class="tool-btn" title="Justify" (click)="applyAlign('justifyFull')">
        ...
        <div class="overflow-tool">
          ...
          @if (overflowOpen()) {
            <div class="overflow-menu" role="menu">
              ...
              <button class="tool-btn" title="Insert table" (click)="canvas?.insertTable(2, 2)">
              ...
              <button class="tool-btn" title="Remove link" (click)="canvas?.unlink()">
              ...
              <button class="tool-btn with-label" title="Insert video" (click)="videoFileInput.click()">
