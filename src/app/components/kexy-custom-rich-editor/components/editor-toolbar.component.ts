...
@Component({
  ...
  template: `
    <div class="toolbar-strip" [class.tools-disabled]="state.mode() !== 'design'">
    ...
    <ng-template #tplSource>
      <button type="button" class="tool-btn" [class.active]="state.mode() === 'html'" title="Source code" (click)="canvas?.toggleSourceMode()">
